...
const ChatMessage: React.FC<ChatMessageProps> = ({ message, darkMode = false }) => {
  ...
  return (
    <div className={`flex w-full mb-6 ${isModel ? 'justify-start' : 'justify-end'}`}>
      <div className={`max-w-[85%] md:max-w-[70%] rounded-2xl p-4 shadow-sm ${
        isModel
          ? d ? 'bg-gray-800 border border-white/10 text-gray-100' : 'bg-white border border-gray-100 text-gray-800'
